											...
											<div class="tab-pane active" id="general">
												<div class="form-body">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="nama" value="<?= (!empty($dataWisata['nama_wisata_alam']))?$dataWisata['nama_wisata_alam']:''; ?>" placeholder="Nama Wisata">
													</div>
													<div class="form-group">
														<label class="control-label">Alamat</label>
														<textarea class="form-control" placeholder="Alamat" name="alamat"><?= (!empty($dataWisata['alamat_wisata_alam']))?$dataWisata['alamat_wisata_alam']:''; ?></textarea>
													</div>
													<div class="form-group">
											...
											<div class="tab-pane" id="konten">
												<div class="form-body">
													<div class="form-group">
														...
														<textarea class="form-control" id="deskripsi" name="deskripsi"><?php echo (!empty($dataWisata['deskripsi_wisata_alam']))?$dataWisata['deskripsi_wisata_alam']:'';?></textarea>
													</div>
												</div>
											</div>
