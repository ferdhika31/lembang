								...
								<div class="portlet-body">
									<div class="tabbable-line">
											...
											<div class="tab-pane active" id="general">
												<div class="form-body">
													<div class="form-group">
														...
														<input type="text" disabled class="form-control" name="nama" value="<?= (!empty($dataWisata['nama_wisata_alam']))?$dataWisata['nama_wisata_alam']:''; ?>" placeholder="Nama Wisata">
													</div>
													<div class="form-group">
														<label class="control-label">Alamat</label>
														<textarea class="form-control" disabled placeholder="Alamat" name="alamat"><?= (!empty($dataWisata['alamat_wisata_alam']))?$dataWisata['alamat_wisata_alam']:''; ?></textarea>
													</div>
													<div class="form-group">
											...
											<div class="tab-pane" id="konten">
												<div class="form-body">
													<div class="form-group">
														...
														<?php echo (!empty($dataWisata['deskripsi_wisata_alam']))?$dataWisata['deskripsi_wisata_alam']:'';?>
													</div>
												</div>
											</div>
										...
										<div class="form-actions">
											<a class="btn blue" href="<?php echo site_url('admin/wisata/edit/'.$this->uri->segment(4));?>">
												Ubah Data
											</a>

											<a class="btn green" href="<?php echo site_url('admin/wisata/status?type=approve&id='.$this->uri->segment(4));?>">
												Terima
											</a>
											<a class="btn red" href="<?php echo site_url('admin/wisata/status?type=reject&id='.$this->uri->segment(4));?>">
												Tolak
											</a>
