					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="row" style="margin-bottom:20px;">
								<div class="col-md-2">
									<a class="btn default green" href="<?php echo site_url('admin/wisata/add');?>">
										<i class="fa fa-plus"></i> Tambah
									</a>
								</div>
								<div class="col-md-5">
									<form action="<?php echo site_url('admin/wisata');?>" method="get">
								...
								<!-- <div class="col-md-1">
									<label class="control-label">Status Wisata</label>
								</div>
								<div class="col-md-3">
									<select class="form-control" onchange="if (this.value) window.location.href=this.value">
										<option value="<?php echo site_url('admin/wisata'); ?>">Semua</option>
										<option value="<?php echo site_url('admin/wisata/aprove'); ?>">Diterima</option>
										<option value="<?php echo site_url('admin/wisata/reject'); ?>">Ditolak</option>
										<option value="<?php echo site_url('admin/wisata/pending'); ?>">Menunggu Konfirmasi</option>
									</select>
								</div> -->
							</div>
